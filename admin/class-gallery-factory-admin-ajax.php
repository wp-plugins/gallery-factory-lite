    ...
    class VLS_Gallery_Factory_Admin_AJAX
    {
        ...
        public function view_album_overview()
        {
            ...
            <div class="vls-gf-toolbar">
                <ul id="vls-gf-toolbar-image-overview">
                    <li>
                        <a id="vls-gf-bulk-select-start-button" href="#">Bulk select</a>
                    </li>
                    <li>
                        <a id="vls-gf-upload-image-button" href="#">Upload images</a>
                    </li>
                </ul>
                <ul id="vls-gf-toolbar-bulk-select-left" style="display: none;">
                    <li>
                        <a id="vls-gf-bulk-select-cancel-button" href="#">Cancel selection</a>
                    </li>
                    <li>
                        <a id="vls-gf-bulk-select-delete-button" href="#">Delete selected</a>
                    </li>
                </ul>
                <ul id="vls-gf-toolbar-bulk-select-right" class="toolbar-right" style="display: none;">
                    <li>
                        <a id="vls-gf-bulk-select-all-button" href="#">Select all</a>
                    </li>
                    <li>
                        <a id="vls-gf-bulk-select-none-button" href="#">Select none</a>
                    </li>
                    <li>
                        <a id="vls-gf-bulk-select-invert-button" href="#">Invert selected</a>
                    </li>
                </ul>
        ...
        public function view_album_layout()
        {
            ...
            $images = $wpdb->get_results(
                $wpdb->prepare("
                    SELECT link.ID as link_id, link.post_name as image_id, link.guid as url, link.menu_order
        ...
        public function async_upload()
        {
            ...
            $file = wp_handle_upload($_FILES['async-upload'], $overrides, $time);
            ...
            VLS_Gallery_Factory_Admin_Utils::addImageFile($file, $album_id);
        ...
        private function subview_image_overview($item_type, $album_id)
        {
            ...
            <div class="vls-gf-image-panel">
                <ul>
                    ...
                    if ($item_type == 'album') {
                        $query = "SELECT link.ID as link_id, link.post_name as image_id, link.guid as guid ";
                        ...
                        $query = "SELECT 0 as link_id, image.ID as image_id, image.guid as guid ";
                    ...
                    foreach ($posts as $link) {
                        echo('<li data-vls-gf-image-id="' . $link->image_id . '" '
                            ...
                            . '><a><img src="' . VLS_Gallery_Factory::_get_image_url($link->guid, 'thumbnail') . '"/></a></li>');
                    }
        ...
        private function output_folder_items($level_no, $parent_id)
        {
            ...
            foreach ($posts as $post) {
                ...
                $itemHtml .= '><a href="#"><span class="icon"></span><span class="label">' . $post->post_title . '</span></a></li>';
        ...
        private function output_mockup_folder_items()
        {
            ...
            ?>
            <li class="folder level-1" data-vls-gf-level="1" data-vls-gf-order="00001"><a href="#"><span
                        class="icon"></span><span class="label">Example folder #1</span></a></li>
            <li class="folder level-2" data-vls-gf-level="2" data-vls-gf-order="00002"><a href="#"><span
                        class="icon"></span><span class="label">Example subfolder #1</span></a></li>
            <li class="folder level-2" data-vls-gf-level="2" data-vls-gf-order="00003"><a href="#"><span
                        class="icon"></span><span class="label">Example subfolder #2</span></a></li>
            <li class="album level-3" data-vls-gf-level="3" data-vls-gf-order="00004" data-vls-gf-id="tour_album"
                data-vls-gf-shortcode="[vls_gf_album id=&quot;42&quot;]"><a href="#"><span class="icon"></span><span
                        class="label">Example album #1</span></a></li>
            <li class="album level-3" data-vls-gf-level="3" data-vls-gf-order="00005" data-vls-gf-id="tour_album"
                data-vls-gf-shortcode="[vls_gf_album id=&quot;42&quot;]"><a href="#"><span class="icon"></span><span
                        class="label">Example album #2</span></a></li>
            <li class="album level-3" data-vls-gf-level="3" data-vls-gf-order="00006" data-vls-gf-id="tour_album"
                data-vls-gf-shortcode="[vls_gf_album id=&quot;42&quot;]"><a href="#"><span class="icon"></span><span
                        class="label">Example album #3</span></a></li>
            <li class="folder level-1" data-vls-gf-level="1" data-vls-gf-order="00007"><a href="#"><span
                        class="icon"></span><span class="label">Example folder #2</span></a></li>
            <li class="folder level-1" data-vls-gf-level="1" data-vls-gf-order="00008"><a href="#"><span
                        class="icon"></span><span class="label">Example folder #3</span></a></li>
        <?php
