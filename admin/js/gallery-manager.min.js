...
var f=d.find("li.vls-gf-dragging-child");f.sort(function(c,a){return parseInt(b(c).data("vlsGfOrder"))-parseInt(b(a).data("vlsGfOrder"))});for(var h=0,z=0;z<=l.length;++z){if(z<l.length)var v=b(l[z]);++h;if(!g&&(z==l.length&&99999==a.nextItemOrder||v.hasClass("vls-gf-deleted")||z<l.length&&a.nextItemOrder==parseInt(v.data("vlsGfOrder")))){g=!0;x.data("vlsGfOrder",h).attr("data-vls-gf-order",h);++h;for(var C=0;C<f.length;++C){var m=b(f[C]),k=parseInt(m.data("vlsGfLevel"))+a.ghostLevel-a.initialLevel,
...
if("vls-gf-btn-gallery-tree-commit"==a.target.id){var c=[];d.find("li").each(function(){var a=b(this),e="",g="",f="",d="",h="";a.data("vlsGfIsAdded")&&(f=a.data("vlsGfIsAdded"));a.data("vlsGfIsRenamed")&&(d=a.data("vlsGfIsRenamed"));a.data("vlsGfIsDeleted")&&(h=a.data("vlsGfIsDeleted"));f&&(g=a.hasClass("album")?"album":"folder");if(f||d)e=a.find(".label").text();c.push({id:parseInt(a.data("vlsGfId")),type:g,order:parseInt(a.data("vlsGfOrder")),level:parseInt(a.data("vlsGfLevel")),name:e,is_added:f,
is_renamed:d,is_deleted:h})});b.post(ajaxurl,{action:"vls_gf_commit_gallery_tree_changes",security:vlsGfGalleryAdminData.nonce,itemData:JSON.stringify(c)},function(a){q()},"json")}else q();return!1}function k(){d.find("li").draggable({distance:2,addClasses:!1,cursor:"move",cancel:".btn",start:t,drag:g,revert:e,stop:u})}function F(a,c){var e=c.helper.data("sourceAlbum"),g;g=b(a.target).hasClass("unsorted")?0:parseInt(b(a.target).data("vlsGfId"));var d=c.helper.data("draggedImages");e!==g&&b.post(ajaxurl,
...
b=b.replace(",",".");b=b.replace(":","/");b=b.replace("-","/");b=b.split("/");f.aspectRatio=parseFloat(b[0]);1<b.length&&(f.aspectRatio=Math.round(f.aspectRatio/parseFloat(b[1])*1E3)/1E3);.25>f.aspectRatio&&(f.aspectRatio=.25);4<f.aspectRatio&&(f.aspectRatio=4);0>f.horizontalSpacing&&(f.horizontalSpacing=0);100<f.horizontalSpacing&&(f.horizontalSpacing=100);0>f.verticalSpacing&&(f.verticalSpacing=0);100<f.verticalSpacing&&(f.verticalSpacing=100);"grid"==f.layoutType?(l.find("#vls-gf-param-grid-horizontal-spacing").val(f.horizontalSpacing.toString()),
l.find("#vls-gf-param-grid-vertical-spacing").val(f.verticalSpacing.toString()),l.find("#vls-gf-param-grid-aspect-ratio").val(f.aspectRatio.toString())):"metro"==f.layoutType&&(l.find("#vls-gf-param-metro-horizontal-spacing").val(f.horizontalSpacing.toString()),l.find("#vls-gf-param-metro-vertical-spacing").val(f.verticalSpacing.toString()),l.find("#vls-gf-param-metro-aspect-ratio").val(f.aspectRatio.toString()));a!=f.layoutType&&(x.find("li.ui-resizable").resizable("destroy"),"metro"==f.layoutType?
(l.find("#vls-gf-parameters-metro").css("display","block"),l.find("#vls-gf-parameters-grid").css("display","none"),x.find("li").resizable({handles:"all",autoHide:!1,minHeight:43,minWidth:43,start:D,resize:H,stop:k})):"grid"==f.layoutType?(l.find("#vls-gf-parameters-metro").css("display","none"),l.find("#vls-gf-parameters-grid").css("display","block")):(l.find("#vls-gf-parameters-metro").css("display","none"),l.find("#vls-gf-parameters-grid").css("display","none")))}function A(a,b){return"x"+("00000"+
a).slice(-5)+"y"+("00000"+b).slice(-5)}function E(a,b){c.position={x:b.position.left+c.centerShift.x,y:b.position.top+c.centerShift.y};if(c.position.x<c.currentArea.left||c.position.x>c.currentArea.right||c.position.y<c.currentArea.top||c.position.y>c.currentArea.bottom)c.currentArea.col=Math.floor(c.position.x/(g+m)),c.currentArea.row=Math.floor(c.position.y/(e+t)),c.currentArea.left=c.currentArea.col*(g+m)-m,c.currentArea.right=(c.currentArea.col+1)*(g+m),c.currentArea.top=c.currentArea.row*(e+
t)-t,c.currentArea.bottom=(c.currentArea.row+1)*(e+t),F()}function D(a,f){var d=b(this);B.css({width:d.css("width"),height:d.css("height"),top:d.css("top"),left:d.css("left")});d.closest("div").append(B);B.fadeIn(300);d.data("vlsGfMetroW")?c.metroSize.width=parseInt(d.data("vlsGfMetroW")):c.metroSize.width=1;c.originalState.width=c.metroSize.width;d.data("vlsGfMetroH")?c.metroSize.height=parseInt(d.data("vlsGfMetroH")):c.metroSize.height=1;c.originalState.height=c.metroSize.height;d.data("vlsGfCol")?
c.originalState.col=parseInt(d.data("vlsGfCol")):c.originalState.col=0;d.data("vlsGfRow")?c.originalState.row=parseInt(d.data("vlsGfRow")):c.originalState.row=0;c.centerShift={x:Math.ceil(g/2),y:Math.ceil(e/2)};c.position={x:f.position.left,y:f.position.top};c.editedItem=d;E(a,f)}function H(a,b){var d=Math.floor((b.size.width-Math.floor(.2*g))/(g+m))+1,f=Math.floor((b.size.height-Math.floor(.2*e))/(e+t))+1;if(d!==c.metroSize.width||f!==c.metroSize.height)c.metroSize.width=d,c.metroSize.height=f,c.currentArea.col=
b.originalPosition.left===b.position.left?c.originalState.col:c.originalState.col+c.originalState.width-d,c.currentArea.row=b.originalPosition.top===b.position.top?c.originalState.row:c.originalState.row+c.originalState.height-f,F()}function k(a,e){B.fadeOut(500,function(){b(this).detach()});c.editedItem=null;F()}function F(){switch(f.layoutType){case "metro":d(f);break;case "grid":a(f)}}function d(){var a=[],d=0,h=0,l,k,n=[],p=0,q=0,r=0,u=0,w=0;x.find("li").each(function(){var d=b(this),e=0,f=0,
g=1,h=1;c.editedItem&&(d.hasClass("ui-draggable-dragging")||d.hasClass("ui-resizable-resizing"))||(d.data("vlsGfCol")&&(e=parseInt(d.data("vlsGfCol"))),d.data("vlsGfRow")&&(f=parseInt(d.data("vlsGfRow"))),d.data("vlsGfMetroW")&&(g=parseInt(d.data("vlsGfMetroW"))),d.data("vlsGfMetroH")&&(h=parseInt(d.data("vlsGfMetroH"))),a.push({element:d,row:f,col:e,width:g,height:h}))});a.sort(function(a,b){return 100*a.row+a.col-100*b.row-b.col});if(c.editedItem){if(c.currentArea.col+c.metroSize.width>f.columnCount)return;
for(d=0;d<c.metroSize.width;++d)for(h=0;h<c.metroSize.height;++h)n.push(A(c.currentArea.col+d,c.currentArea.row+h));for(k=!1;!k;)0>b.inArray(A(q,p),n)?k=!0:(++q,q>=f.columnCount&&(q=0,++p));B.css({width:c.metroSize.width*(g+m)-m+"px",height:c.metroSize.height*(e+t)-t+"px",left:c.currentArea.col*(g+m)+"px",top:c.currentArea.row*(e+t)+"px"});c.editedItem.data("vlsGfCol",c.currentArea.col);c.editedItem.data("vlsGfRow",c.currentArea.row);c.editedItem.data("vlsGfMetroW",c.metroSize.width);c.editedItem.attr("data-vls-gf-metro-w",
c.metroSize.width);c.editedItem.data("vlsGfMetroH",c.metroSize.height);c.editedItem.attr("data-vls-gf-metro-h",c.metroSize.height);w<c.currentArea.row+c.metroSize.height-1&&(w=c.currentArea.row+c.metroSize.height-1)}for(l=0;l<a.length;++l){var y=a[l];y.width>f.columnCount&&(y.width=f.columnCount);k=!1;u=q;for(r=p;!k;){k=!0;for(d=0;d<y.width;++d)for(h=0;h<y.height;++h)if(u+d>=f.columnCount||0<=b.inArray(A(u+d,r+h),n))k=!1;k||(++u,u>=f.columnCount&&(u=0,++r))}for(d=0;d<y.width;++d)for(h=0;h<y.height;++h)n.push(A(u+
d,r+h));d=(g+m)*u;h=(e+t)*r;y.element.css("width",y.width*g+(y.width-1)*m+"px").css("height",y.height*e+(y.height-1)*t+"px").css("top",h+"px").css("left",d+"px");y.element.data("vlsGfCol",u);y.element.data("vlsGfRow",r);w<r+y.height-1&&(w=r+y.height-1);for(k=!1;!k;)0>b.inArray(A(q,p),n)?k=!0:(++q,q>=f.columnCount&&(q=0,++p))}x.find("ul").css("height",(w+1)*e+w*t)}function a(){var a=[],d=0,h=0,l,k=0,n=0,p=0;x.find("li").css("width",g+"px").css("height",e+"px").each(function(){var d=b(this),e=0,f=0,
g=0;c.editedItem&&(d.hasClass("ui-draggable-dragging")||d.hasClass("ui-resizable-resizing"))||(d.data("vlsGfCol")&&(e=parseInt(d.data("vlsGfCol"))),d.data("vlsGfRow")&&(f=parseInt(d.data("vlsGfRow"))),d.data("vlsGfLinkId")&&(g=parseInt(d.data("vlsGfLinkId"))),a.push({element:d,row:f,col:e,linkId:g}))});a.sort(function(a,b){return 100*a.row+a.col-100*b.row-b.col});c.editedItem&&(B.css({left:c.currentArea.col*(g+m)+"px",top:c.currentArea.row*(e+t)+"px"}),c.editedItem.data("vlsGfCol",c.currentArea.col),
c.editedItem.data("vlsGfRow",c.currentArea.row),p<c.currentArea.row&&(p=c.currentArea.row));for(l=n=k=0;l<a.length;++l){var q=a[l];c.editedItem&&c.currentArea.col==n&&c.currentArea.row==k&&(++n,n>=f.columnCount&&(n=0,++k));d=(g+m)*n;h=(e+t)*k;q.element.css("top",h+"px").css("left",d+"px");q.element.data("vlsGfCol",n).attr("data-vls-gf-col",n);q.element.data("vlsGfRow",k).attr("data-vls-gf-row",k);p<k&&(p=k);++n;n>=f.columnCount&&(n=0,++k)}x.find("ul").css("height",(p+1)*e+p*t)}function h(){var a=
b(this);if(!a.hasClass("vls-gf-processing")){a.addClass("vls-gf-processing");var c={layout_type:f.layoutType,column_count:f.columnCount,aspect_ratio:f.aspectRatio,horizontal_spacing:f.horizontalSpacing,vertical_spacing:f.verticalSpacing},d=[];x.find("li").each(function(){var a=b(this);d.push({link_id:a.data("vlsGfLinkId"),col:a.data("vlsGfCol"),row:a.data("vlsGfRow"),metro_w:a.data("vlsGfMetroW"),metro_h:a.data("vlsGfMetroH")})});b.post(ajaxurl,{action:"vls_gf_update_album_layout",security:vlsGfGalleryAdminData.nonce,
album_id:n,options:JSON.stringify(c),images:JSON.stringify(d)},function(c){a.removeClass("vls-gf-processing");b(".vls-gf-update-feedback").show().fadeOut(3E3)})}}var n,c={editedItem:null,metroSize:{width:1,height:1},centerShift:{x:0,y:0},originalState:{width:1,height:1,col:0,row:0},position:{x:0,y:0},currentArea:{col:0,row:0,left:0,right:0,top:0,bottom:0}},p,x,l;r=0;q=1;t=m=e=g=0;var f={layoutType:"",columnCount:0,aspectRatio:1,horizontalSpacing:0,verticalSpacing:0},B=b('<div class="vls-gf-dragging-placeholder"></div>');
return{loadContent:function(a){n=a;b.getJSON(ajaxurl,{action:"vls_gf_view_album_layout",album_id:n,tour:VLS_GF.TourModule&&VLS_GF.TourModule.isActive()},u)}}}(jQuery);
VLS_GF.ItemEditPanelModule=function(b){function q(m){b(".vls-gf-tab-view").empty().append(m.view);b("#vls-gf-item-details button.button-primary").on("click.vls-gf",r)}function r(m){m.preventDefault();var q=b("#vls-gf-item-details"),g=q.find("button.button-primary");if(!g.hasClass("disabled")){g.addClass("disabled");q.find(".vls-gf-update-feedback").hide();var e={action:"vls_gf_update_album_details"};q.find("input, select, textarea").each(function(){e[this.name]=this.value});b.post(ajaxurl,e,function(){g.removeClass("disabled");
q.find(".vls-gf-update-feedback").show().fadeOut(3E3)})}}return{loadContent:function(m,r){b.getJSON(ajaxurl,{action:"vls_gf_view_gallery_item_edit",item_type:m,item_id:r,tour:VLS_GF.TourModule&&VLS_GF.TourModule.isActive()},q)}}}(jQuery);jQuery(document).ready(function(){VLS_GF.TourModule&&VLS_GF.TourModule.start();VLS_GF.GalleryManager.init()});
