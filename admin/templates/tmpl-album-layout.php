<div class="vls-gf-toolbar">
    ...
    <button class="vls-gf-btn-save-layout button-primary"><?php _e('Save layout', 'vls_gallery_factory') ?></button>
    <span class="vls-gf-update-feedback"><?php _e('saved', VLS_GF_TEXTDOMAIN); ?></span>
</div>
