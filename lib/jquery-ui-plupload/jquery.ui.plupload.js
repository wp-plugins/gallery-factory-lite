//using bridge to avoid possible conflict with bootstrap button
...
(function (window, document, plupload, o, $) {
    ...
    function renderUI(obj) {
        ...
        obj.html(
            ...
            '<a class="plupload_button plupload_cancel">' + _("Cancel") + '</a>&nbsp;' +
            '</div>' +
    ...
    $.widget("ui.plupload", {
        ...
        _create: function () {
            ...
            this.cancel_button = $('.plupload_cancel', this.container).attr('id', id + '_cancel');
            this.thumbs_switcher = $('#' + id + '_view_thumbs');
            this.list_switcher = $('#' + id + '_view_list');

            if ($.ui.button) {
                this.browse_button.uibutton({
                ...
                this.stop_button.uibutton({
                    icons: {primary: 'ui-icon-circle-close'}
                });

                this.cancel_button.uibutton({
                    icons: {primary: 'ui-icon-circle-close'}
                });

                this.list_switcher.uibutton({
                    text: false,
                    icons: {secondary: "ui-icon-grip-dotted-horizontal"}
                });

                this.thumbs_switcher.uibutton({
                    text: false,
        ...
        _initUploader: function () {
            ...
            if (self.options.dragdrop) {
                var $drop_element = this.filelist.parent();
                $drop_element.attr('id', this.id + '_dropbox');
                ...
                $drop_element.on({
                    ...
                    drop: function (e) {
                        $(this).removeClass('drop_active');
                        $(this).find('.plupload_droptext').remove();
                    }
                });
            }
            ...
            plupload.addFileFilter('max_file_count', function (maxCount, file, cb) {
                if (maxCount <= this.files.length - (this.total.uploaded + this.total.failed)) {
                    self.browse_button.uibutton('disable');
                    this.disableBrowse();
            ...
            uploader.bind('PostInit', function (up) {
                ...
                if (!self.options.buttons.browse) {
                    self.browse_button.uibutton('disable').hide();
                    up.disableBrowse(true);
                } else {
                    self.browse_button.uibutton('enable');
                }

                if (!self.options.buttons.start) {
                    self.start_button.uibutton('disable').hide();
                }

                if (!self.options.buttons.stop) {
                    self.stop_button.uibutton('disable').hide();
                }
                ...
                self.start_button.click(function (e) {
                    if (!$(this).uibutton('option', 'disabled')) {
                        self.start();
                    }
                    e.preventDefault();
                });
                ...
                self.cancel_button.click(function (e) {
                    //$('#vls-gf-upload-panel').slideUp();
                    self.clearQueue();
                    e.preventDefault();
                });
        ...
        _setOption: function (key, value) {
            ...
            if (key == 'buttons' && typeof(value) == 'object') {
                ...
                if (!value.browse) {
                    ...
                    self.browse_button.uibutton('enable').show();
                ...
                if (!value.start) {
                    ...
                    self.start_button.uibutton('enable').show();
                }
        ...
        _handleState: function () {
            ...
            if (plupload.STARTED === up.state) {
                ...
                this.start_button.uibutton('disable');
                this.cancel_button.uibutton('disable').hide();
                ...
                if (filesPending) {
                    this.start_button.uibutton('enable');
                } else {
                    this.start_button.uibutton('disable');
                }

                this.cancel_button.uibutton('enable').show();
        ...
        _addFiles: function (files) {
            ...
            '<div class="plupload_file_dummy ui-widget-content"><span class="ui-state-disabled"></span></div>' +
            '</div>' +
